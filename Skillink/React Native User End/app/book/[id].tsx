...
export default function BookDetailScreen() {
    ...
    const rating = typeof book?.rating === 'number' ? book.rating.toFixed(1) : '4.0';
    const level = book?.level || 'All Levels';
    const duration = book?.duration || 'Self-paced';
            ...
            <ScrollView contentContainerStyle={styles.content}>
                {loading ? (
                    <View style={styles.stateContainer}>
                        ...
                        <Text style={styles.stateText}>Loading book details...</Text>
                    </View>
                ) : error ? (
                    <View style={styles.stateContainer}>
                        ...
                        <View style={styles.heroCard}>
                            {imageUrl ? (
                                ...
                                <View style={styles.heroPlaceholder}>
                                    <Ionicons name="book-outline" size={42} color="#5B6BFF" />
                                </View>
                            )}
